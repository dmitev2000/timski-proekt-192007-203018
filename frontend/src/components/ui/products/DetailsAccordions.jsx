                                ...
                                <ul>
                                    ...
                                    {sectionId === "Memory" && (
                                        <>
                                            ...
                                            <ListItem>
                                                <ListItemText
                                                    primary={`Card slot: ${data.memory_card_slot ? "Yes" : "No"
                                                        }`}
                                                />
                                            </ListItem>
                                        </>
                                ...
                                <ul>
                                    ...
                                    {sectionId === "Sound" && (
                                        <>
                                            <ListItem>
                                                <ListItemText
                                                    primary={`Loudspeaker: ${data.sound_loudspeaker ? "Yes" : "No"
                                                        }`}
                                                />
                                            </ListItem>
                                            <ListItem>
                                ...
                                <ul>
                                    ...
                                    {sectionId === "Main Camera" && (
                                        <>
                                            ...
                                            <ListItem>
                                                <ListItemText
                                                    primary={`Features: ${data.main_camera_features !== null
                                    ...
                                    {sectionId === "Selfie Camera" && (
                                        <>
                                            ...
                                            <ListItem>
                                                <ListItemText
                                                    primary={`Features: ${data.selfie_camera_features !== null
